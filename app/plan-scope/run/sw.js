...
// versione apposta: dentro c'è il digest che `biz/remind.js` scrive dalla pagina — le scadenze con
...
const ASSETS = [
  ...
  '../../_business/zip.js',
  '../../_business/folder.js',
  '../../_business/plan-markdown.js',
  '../../_business/plan-editor.js',
  '../../_business/plan-editor.css',
  '../../_business/clip.js',
  '../../_lib/dom.js',
  '../../_business/plan-pack.js',
  '../../_business/plan-model.js',
  '../../_business/remind.js',
  '../../_business/remind-sw.js',
  '../../_business/ics.js',
];
...
// ---- i promemoria ------------------------------------------------------------------------------
//
// Le quaranta righe che decidono cosa dire al risveglio stanno in `_business/remind-sw.js`, uguali
// per le due app: `importScripts` è il solo modo che ha uno script classico di prendere codice da
// fuori, e vale la pena usarlo proprio qui — è il file che gira quando nessuno guarda, e averne due
// copie voleva dire provarne una.
importScripts('../../_business/remind-sw.js');

remindSetup({
  notes: NOTES,
  title: 'Plan Scope',
  scope: '/app/plan-scope/run/',
  digest: DIGEST,
});
