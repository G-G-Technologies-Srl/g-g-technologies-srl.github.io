...
const IT = {
  ...
  appMoreLabel: "Archivio e comandi",
  placesTitle: "Cartelle e copie",
  rubricaTitle: "Rubrica",
  agendaTitle: "Calendario",
  agendaHint: "Gli appuntamenti e le scadenze di tutti i progetti, mese per mese. Toccando un "
    + "giorno vuoto si prende un appuntamento.",
  agendaEmpty: "Questo mese non ha niente in programma.",
  agendaProject: "Agenda",
  agendaMade: "L'appuntamento sta in «Agenda», con quello che non appartiene a un progetto.",
  peopleTitle: "Chi ci lavora",
  propKind: "tipo",
  propColour: "colore",
  propDate: "data",
  propTime: "ora",
  ...
  propWhere: "dove",
  propChannel: "canale",
  meetingKind: "incontro",
  newMeeting: "Appuntamento",
  newNote: "Nota",
  ...
  meetDate: "Il giorno",
  meetTime: "L'ora, se c'è",
  meetWith: "Con chi",
  meetWhere: "Dove",
  meetWhereHint: "Un indirizzo, o il link della web-call",
  meetOk: "Segna l'appuntamento",
  meetWithMany: "Più nomi, separati da virgola",
  meetTodayHint: "Senza ora, un incontro di oggi vale come nota: non compare fra le scadenze e non "
    + "suona. Indicando l'ora resta davanti fino a quel momento.",
  personWriteTo: "Scrivere una email a {who}",
  personCallTo: "Chiamare {who}",
  contactsMadeOne: "«{name}» è in rubrica, da completare.",
  contactsMade: "{n} persone nuove in rubrica.",
  propOpenPerson: "Apri la scheda in rubrica",
  propPickPerson: "+ persona…",
  meetNew: "+ Nuovo appuntamento",
  meetEditTitle: "L'appuntamento",
  meetSave: "Salva",
  meetOpen: "Apri le note",
  meetTrash: "Elimina",
  meetSaved: "Appuntamento aggiornato",
  meetingTitle: "Incontro del {date}",
  noteChannelAsk: "Com'è avvenuto?",
  noteChannel_call: "Telefonata",
  noteChannel_meeting: "Incontro",
  noteChannel_email: "Email",
  noteChannel_message: "Messaggio",
  noteTitle_call: "Telefonata del {date}",
  noteTitle_meeting: "Incontro del {date}",
  noteTitle_email: "Email del {date}",
  noteTitle_message: "Messaggio del {date}",
  meetingSet: "Appuntamento segnato: {when}.",
  meetingHint: "Qui va quello che vi siete detti. Un'attività del progetto si crea dal menu «/», e "
    + "resta collegata alla sua riga.",
  boxesToPlan: "Porta le caselle nel piano",
  boxesNone: "Nessuna casella da portare: le righe che cominciano con «- [ ]» diventano attività.",
  boxesDone: "{n} attività nel piano.",
  boxesDoneOne: "Un'attività nel piano.",
  meetingWhere: "In quale progetto?",
  peopleAll: "Rubrica →",
  ...
  peopleRemoved: "«{name}» non lavora più a questo progetto. La sua scheda resta in rubrica.",
  contactsCsv: "Foglio di calcolo",
  contactsVcf: "vCard",
  rubricaHint: "Le persone con cui si lavora, una volta sola per tutti i progetti. Una scheda si può "
    + "aggiungere qui, o nasce da sé la prima volta che un nome compare su un'attività.",
  rubricaSearch: "Cerca una persona",
  rubricaEmpty: "Ancora nessuno. La prima persona nasce da qui, o dal nome scritto su un'attività.",
  rubricaIn: "in {n} progetti",
  rubricaInOne: "in un progetto",
  rubricaNowhere: "in nessun progetto",
  newPerson: "Nuova persona",
  newPersonAsk: "Come si chiama?",
  personMaybe: "«{name}» è una persona che è già in rubrica?",
  personMaybeIn: "Nella pagina «{page}»: «{name}» è una persona che è già in rubrica?",
  personMaybeNew: "«{name}» è un'altra persona",
  personName: "Nome",
  personCompany: "Azienda",
  personRole: "Ruolo",
  personEmail: "Email",
  ...
  personTrashed: "«{name}» è nel cestino.",
  personProjectsTitle: "Dove lavora",
  personProjectsNone: "Non è ancora in nessun progetto.",
  personAheadTitle: "Prossimi appuntamenti",
  personMeetingsTitle: "Cosa vi siete detti",
  personMeetingsNone: "Nessun incontro che la nomini. Una pagina con «con: {name}» in testa compare qui.",
  ...
  personNoName: "Persona senza nome",
  taskUntitled: "Attività senza titolo",
  cardDoc: "Il documento",
  cardDocShort: "Documento",
  cardDocMake: "Aggiungi un documento",
  cardDocOff: "Stacca",
  cardDocOpenOne: "Apri il documento",
  cardDocHint: "Per quello che nelle note non ci sta: allegati, immagini, sottopagine. È una pagina "
    + "del progetto, e si scrive come le altre.",
  cardDocWhich: "Quale documento?",
  cardDocNew: "Una pagina nuova",
  cardDocOk: "Aggancia",
  cardDocGone: "Documento staccato da «{name}»",
  pageTaskOf: "Documento dell'attività",
  pageTaskOpen: "Apri l'attività",
  langSwitch: "EN",
  ...
  projectDateLabel: "Una data da tenere d'occhio, se ce n'è una",
  projectDateKeyHint: "Come si chiama (consegna, fiera…)",
  projectDateHint: "Il giorno",
  propDateDefault: "data",
  propMarkDate: "Fai di questa la data del progetto",
  ...
  backupRestoreAsk: "Riporto l'archivio com'era in questa copia. Quello che c'è adesso nell'app "
    + "viene sostituito, e non si torna indietro. Vado avanti?",
  ...
  todayTitle: "In programma",
  todayCalendar: "Tutto il calendario",
  homeSortLabel: "Ordina per",
  homeSortRecent: "Ultima modifica",
  homeSortDue: "Scadenza",
  homeSortName: "Nome",
  homeViewLabel: "Vista",
  homeViewCards: "Schede",
  homeViewList: "Elenco",
  meetingOne: "1 incontro",
  meetingMany: "{n} incontri",
  cardEdited: "Modificata",
  cardCreated: "Creato {when}",
  cardEmpty: "Ancora vuoto. Si comincia da una pagina o da un'attività.",
  cardMore: "+ altre {n}",
  cardFirstPage: "Scrivi la prima pagina",
  cardFirstTask: "Aggiungi un'attività",
  cardShared: "Condiviso",
  cardNoTasks: "nessuna attività",
  agoNow: "adesso",
  agoMinutes: "{n} min fa",
  agoHour: "un'ora fa",
  agoHours: "{n} ore fa",
  ...
  projectSearch: "Cerca un progetto",
  projectsNoName: "Nessun progetto con questo nome.",
  archivedShow: "Archiviati · {n}",
  archivedTitle: "Archiviati",
  archivedBadge: "Archiviato",
  archiveProject: "Archivia",
  unarchiveProject: "Riporta fra i progetti",
  archivedDone: "«{name}» è fra gli archiviati.",
  unarchivedDone: "«{name}» è di nuovo fra i progetti.",
  treeFromTemplate: "Da un modello…",
  ...
  lastContact: "ultimo contatto {when}",
  agoToday: "oggi",
  meetRepeat: "Si ripete",
  propRepeat: "ripete",
  repeat_none: "Non si ripete",
  repeat_week: "Ogni settimana",
  repeat_fortnight: "Ogni 2 settimane",
  repeat_month: "Ogni mese",
  todayEmpty: "Niente in programma questa settimana. Buona giornata.",
  dueLateTitle: "In ritardo",
  dueTodayTitle: "Oggi",
  dueTomorrowTitle: "Domani",
  dueLaterTitle: "Prossimi giorni",
  ...
  weeksEmpty: "Niente con una data in queste settimane.",
  nowBriefTitle: "Brief",
  ...
  nextWith: "con {who}",
  rowOpenProject: "Apri il progetto «{name}»",
  ...
  calDayAsk: "Il {day}: che cosa si segna?",
  calDayTask: "Un'attività",
  calDayMeeting: "Un appuntamento",
  addTask: "Aggiungi",
  ...
  priorityLow: "Bassa",
  priorityHigh: "Alta",
  hintRepeat: "Si ripete {every}: spuntata, ne nasce una nuova",
  tipRepeat: "Si ripete {every}",
  tipRepeatNext: "la prossima il {date}",
  tipRepeatUntil: "la prossima il {date}, fino al {until}",
  tipRepeatLast: "questa è l'ultima della serie",
  tipLate: "In ritardo di {n} giorni",
  tipLateOne: "In ritardo di un giorno",
  tipLateWas: "scadeva il {date}",
  tipHigh: "Priorità alta",
  tipHighBy: "da fare entro il {date}",
  tipHighNone: "passa davanti alle altre",
  tipBlocked: "Bloccata",
  tipBlockedBy: "aspetta «{title}»",
  tipBlockedMore: "aspetta «{title}» e altre {n}",
  tipOpen: "Apri «{title}»",
  tipDecide: "Da decidere",
  tipDecideBy: "Da decidere entro il {date}",
  tipDecideLate: "Da decidere: il {date} è passato",
  tipDecideIn: "nelle note di «{title}»",
  tipNotes: "Note da scrivere",
  tipNotesDetail: "«{title}» c'è stato {when} e non ha appunti",
  tipWaitingOne: "Ferma un'altra attività",
  tipWaiting: "Ferma {n} attività",
  tipMilestone: "Traguardo",
  ...
  editorNote: "Si scrive e basta. Su una riga vuota: / apre l'elenco dei blocchi, «# » fa un titolo, "
    + "«- » un elenco. La maniglia ⣿ accanto a un blocco lo sposta; premuta, lo trasforma.",
  ...
  blockTask: "Attività del progetto",
  taskAsk: "Che cosa c'è da fare?",
  taskMade: "«{name}» è sulla bacheca.",
  taskChipOpen: "apri",
  taskRemove: "Elimina l'attività",
  taskRemoved: "«{name}» eliminata, e la riga con lei.",
  taskChipDone: "fatta",
  taskChipGone: "eliminata",
  ...
  tpl_event: "Evento",
  tpl_event_date: "evento",
  tpl_campaign_date: "partenza",
  tpl_launch_date: "lancio",
  ...
  propKey: "Nome",
  propValue: "Valore",
  propPickDate: "Scegli la data",
  propPickColor: "Scegli il colore",
  propPickTime: "Scegli l'ora",
  propOpenWhere: "Apri il posto",
  propRemove: "Togli la proprietà",
  pagesTable: "Vedi come tabella",
  panelPlan: "Apri il piano →",
  panelCalendar: "Vedi il calendario →",
  panelPages: "Tutte le pagine →",
  pagesCount: "{n} pagine",
  pagesTableEmpty: "Nessuna pagina con questi filtri.",
  colTitle: "Titolo",
  colTags: "Tag",
  colUpdated: "Modificata",
  projectTagsLabel: "Etichette, separate da una virgola",
  ...
  remindHour: "alle ore",
  remindBefore: "Per gli appuntamenti,",
  ...
  remindMeetingAt: "{title} — {when} alle {time}",
  ...
  tableOne: "1 tabella",
  tableMany: "{n} tabelle",
  blockOne: "1 paragrafo",
  blockMany: "{n} paragrafi",
  importFile: "Importa un file",
  importDocDone: "«{name}»: {what}. L'originale è allegato in fondo.",
  importDocEmpty: "«{name}» non ha testo da portare dentro.",
  importDocFailed: "«{name}» non si apre come documento di Word. Per ora leggo solo i «.docx».",
  importDocFrom: "Importato da {file}",
  dayOne: "1 giorno",
  dayMany: "{n} giorni",
};
...
const EN = {
  ...
  viewsLabel: "How to look at the project",
  appMoreLabel: "Archive and commands",
  placesTitle: "Folders and copies",
  rubricaTitle: "Address book",
  agendaTitle: "Calendar",
  agendaHint: "Appointments and deadlines from every project, month by month. Touch an empty day "
    + "to make an appointment.",
  agendaEmpty: "Nothing on this month.",
  agendaProject: "Diary",
  agendaMade: "The appointment is in “Diary”, with everything that belongs to no project.",
  peopleTitle: "Who works on it",
  propKind: "type",
  propColour: "colour",
  propDate: "date",
  propTime: "time",
  ...
  meetDate: "The day",
  meetTime: "The time, if there is one",
  meetWith: "Who with",
  meetWhere: "Where",
  meetWhereHint: "An address, or the web-call link",
  meetOk: "Put it in",
  meetWithMany: "Several names, separated by commas",
  meetTodayHint: "With no time, a meeting today counts as a note: it stays out of what is due and "
    + "never rings. With a time it stays ahead until that moment.",
  personWriteTo: "Send an email to {who}",
  personCallTo: "Call {who}",
  contactsMadeOne: "“{name}” is in the address book, to be completed.",
  contactsMade: "{n} new people in the address book.",
  propOpenPerson: "Open the card in the address book",
  propPickPerson: "+ person…",
  meetNew: "+ New appointment",
  meetEditTitle: "The appointment",
  meetSave: "Save",
  meetOpen: "Open the notes",
  meetTrash: "Delete",
  meetSaved: "Appointment updated",
  meetingTitle: "Meeting on {date}",
  noteChannelAsk: "How did it happen?",
  noteChannel_call: "Call",
  noteChannel_meeting: "Meeting",
  noteChannel_email: "Email",
  noteChannel_message: "Message",
  noteTitle_call: "Call on {date}",
  noteTitle_meeting: "Meeting on {date}",
  noteTitle_email: "Email of {date}",
  noteTitle_message: "Message of {date}",
  meetingSet: "Appointment set: {when}.",
  meetingHint: "This is where what you said to each other goes. A project task is made from the “/” "
    + "menu, and stays linked to its line.",
  boxesToPlan: "Take the boxes into the plan",
  boxesNone: "No box to take: lines starting with “- [ ]” become tasks.",
  boxesDone: "{n} tasks in the plan.",
  boxesDoneOne: "One task in the plan.",
  meetingWhere: "In which project?",
  peopleAll: "Address book →",
  peopleNone: "Nobody yet. Write a name below, or assign a task to somebody: they will show up here.",
  ...
  peopleRemoved: "“{name}” no longer works on this project. Their card stays in the address book.",
  contactsCsv: "Spreadsheet",
  contactsVcf: "vCard",
  rubricaHint: "The people you work with, once for every project. A card can be added here, or is "
    + "born by itself the first time you write a name on a task.",
  rubricaSearch: "Find a person",
  rubricaEmpty: "Nobody yet. The first person comes from here, or from a name you write on a task.",
  rubricaIn: "in {n} projects",
  rubricaInOne: "in one project",
  rubricaNowhere: "in no project",
  newPerson: "New person",
  newPersonAsk: "What is their name?",
  personMaybe: "Is “{name}” somebody already in the address book?",
  personMaybeIn: "In the page “{page}”: is “{name}” somebody already in the address book?",
  personMaybeNew: "“{name}” is somebody else",
  personName: "Name",
  ...
  personTrashed: "“{name}” is in the bin.",
  personProjectsTitle: "Where they work",
  personProjectsNone: "Not in any project yet.",
  personAheadTitle: "Coming up",
  personMeetingsTitle: "What you said to each other",
  personMeetingsNone: "No meeting names them. A page with “with: {name}” at the top shows up here.",
  personTasksTitle: "How you left it",
  personTasksNone: "No open task assigned to them.",
  personAddWhere: "Which project?",
  personAddWhereNone: "They already work on every project you have.",
  personJoined: "Now working on “{project}”.",
  personLeft: "No longer working on “{project}”. Their card stays in the address book.",
  personNoName: "Person with no name",
  taskUntitled: "Task with no title",
  cardDoc: "The document",
  cardDocShort: "Document",
  cardDocMake: "Add a document",
  cardDocOff: "Unlink",
  cardDocOpenOne: "Open the document",
  cardDocHint: "For what does not fit in the notes: attachments, images, sub-pages. It is a page of "
    + "the project, and it is written like the others.",
  cardDocWhich: "Which document?",
  cardDocNew: "A new page",
  cardDocOk: "Link it",
  cardDocGone: "Document unlinked from “{name}”",
  pageTaskOf: "Document of the task",
  pageTaskOpen: "Open the task",
  langSwitch: "IT",
  ...
  projectDateLabel: "A date to keep an eye on, if there is one",
  projectDateKeyHint: "What it is called (delivery, fair…)",
  projectDateHint: "The day",
  propDateDefault: "date",
  propMarkDate: "Make this the project's date",
  createProject: "Create the project",
  cancelProject: "Never mind",
  folderTitle: "The folders for working as two",
  folderHint: "Every project goes in the folder you choose for it: one with this client, another "
    + "with that one, and the ones you do not share stay here and nowhere else. A folder inside "
    + "Dropbox, OneDrive, Google Drive or SharePoint carries the project to whoever has it, and "
    + "brings their work back.",
  folderWho: "Your name",
  ...
  folderOpen: "Open a shared folder…",
  folderOpenOne: "Open",
  folderNewNote: "The projects indented below are in your folders and not yet in this app. Open "
    + "them when you need them: nothing comes in by itself.",
  folderForget: "Forget",
  folderResumeOne: "Take it up again",
  folderResume: "Take up the folder again",
  folderSeeAll: "See the folders",
  folderHere: "your own copy is here too",
  folderIsProject: "the folder is the project",
  folderNothingIn: "no project in here yet",
  folderMore: "and {n} more",
  folderToOpenOne: "one to open",
  ...
  sharedAdrift: "It says it is shared, but there is no folder to write it into: nothing leaves "
    + "from here. It happens to projects shared before 4.0, when there was a single folder.",
  sharedFix: "Choose where",
  sharedOff: "Tick to write it into a folder: I will let you choose which. From then on it saves itself, at every change: there is nothing to press.",
  ...
  sharedOnSelf: "In the folder “{folder}” · written at {time} · updates itself at every change, within seconds.",
  ...
  backupNote: "It also keeps one copy a day for the last thirty days, so a change made wrongly is "
    ...
    + "there is the shared folder, which is another thing.",
  backupPick: "Choose the folder…",
  backupResume: "Take up the folder again",
  ...
  backupRestoreAsk: "I bring the archive back to how it was in this copy. What is in the app now "
    + "is replaced, and there is no undo. Go ahead?",
  backupRestoreDone: "Archive brought back: {records} records and {images} images.",
  backupRestoreFail: "The copy stays as it is: {reason}",
  ...
  dropTextSelf: "I stop following the folder “{folder}”. The folder itself is untouched: it "
    + "belongs to whoever shared it with you, and the work you have here stays here. The project "
  ...
  todayTitle: "Coming up",
  todayCalendar: "The whole calendar",
  homeSortLabel: "Sort by",
  homeSortRecent: "Last change",
  homeSortDue: "Deadline",
  homeSortName: "Name",
  homeViewLabel: "View",
  homeViewCards: "Cards",
  homeViewList: "List",
  meetingOne: "1 meeting",
  meetingMany: "{n} meetings",
  cardEdited: "Changed",
  cardCreated: "Created {when}",
  cardEmpty: "Empty so far. It starts with a page or a task.",
  cardMore: "+ {n} more",
  cardFirstPage: "Write the first page",
  cardFirstTask: "Add a task",
  cardShared: "Shared",
  cardNoTasks: "no tasks",
  agoNow: "just now",
  ...
  projectsNoName: "No project by this name.",
  archivedShow: "Archived · {n}",
  archivedTitle: "Archived",
  archivedBadge: "Archived",
  archiveProject: "Archive",
  unarchiveProject: "Bring back to the projects",
  archivedDone: "“{name}” is archived.",
  unarchivedDone: "“{name}” is back among the projects.",
  treeFromTemplate: "From a template…",
  ...
  repeat_fortnight: "Every 2 weeks",
  repeat_month: "Every month",
  todayEmpty: "Nothing on this week. Have a good day.",
  dueLateTitle: "Late",
  dueTodayTitle: "Today",
  dueTomorrowTitle: "Tomorrow",
  dueLaterTitle: "The days ahead",
  ...
  weeksEmpty: "Nothing with a date in these weeks.",
  nowBriefTitle: "Brief",
  ...
  nextWith: "with {who}",
  rowOpenProject: "Open the project «{name}»",
  nextTalk: "To discuss",
  ...
  calDayAsk: "On {day}: what goes in?",
  calDayTask: "A task",
  calDayMeeting: "An appointment",
  addTask: "Add",
  ...
  priorityLow: "Low",
  priorityHigh: "High",
  hintRepeat: "Repeats {every}: once ticked, a new one appears",
  tipRepeat: "Repeats {every}",
  tipRepeatNext: "the next one on {date}",
  tipRepeatUntil: "the next one on {date}, until {until}",
  tipRepeatLast: "this is the last one in the series",
  tipLate: "{n} days late",
  tipLateOne: "One day late",
  tipLateWas: "it was due on {date}",
  tipHigh: "High priority",
  tipHighBy: "due by {date}",
  tipHighNone: "it comes before the others",
  tipBlocked: "Blocked",
  tipBlockedBy: "waiting for «{title}»",
  tipBlockedMore: "waiting for «{title}» and {n} more",
  tipOpen: "Open «{title}»",
  tipDecide: "To decide",
  tipDecideBy: "To decide by {date}",
  tipDecideLate: "To decide: {date} has passed",
  tipDecideIn: "in the notes of «{title}»",
  tipNotes: "Notes to write",
  tipNotesDetail: "«{title}» took place {when} and has no notes",
  tipWaitingOne: "Holds up another task",
  tipWaiting: "Holds up {n} tasks",
  tipMilestone: "Milestone",
  ...
  blockCheck: "Checklist",
  blockTask: "Project task",
  taskAsk: "What needs doing?",
  taskMade: "“{name}” is on the board.",
  taskChipOpen: "open",
  taskRemove: "Delete the task",
  taskRemoved: "“{name}” deleted, and its line with it.",
  taskChipDone: "done",
  taskChipGone: "deleted",
  ...
  tpl_event: "Event",
  tpl_event_date: "event",
  tpl_campaign_date: "start",
  tpl_launch_date: "launch",
  ...
  propKey: "Name",
  propValue: "Value",
  propPickDate: "Pick the date",
  propPickColor: "Pick the colour",
  propPickTime: "Pick the time",
  propOpenWhere: "Open the place",
  propRemove: "Remove the property",
  pagesTable: "See as a table",
  panelPlan: "Open the plan →",
  panelCalendar: "See the calendar →",
  panelPages: "All the pages →",
  pagesCount: "{n} pages",
  pagesTableEmpty: "No page matches these filters.",
  colTitle: "Title",
  colTags: "Tags",
  colUpdated: "Changed",
  projectTagsLabel: "Labels, separated by commas",
  projectsFiltered: "No project carries this label.",
  ...
  remindHour: "at",
  remindBefore: "For appointments,",
  remindBeforeUnit: "minutes before",
  remindSave: "Save",
  ...
  tableOne: "1 table",
  tableMany: "{n} tables",
  blockOne: "1 paragraph",
  blockMany: "{n} paragraphs",
  importFile: "Import a file",
  importDocDone: "“{name}”: {what}. The original is attached at the end.",
  importDocEmpty: "“{name}” has no text to bring in.",
  importDocFailed: "“{name}” does not open as a Word document. For now I only read “.docx” files.",
  importDocFrom: "Imported from {file}",
  dayOne: "1 day",
  dayMany: "{n} days",
};
