...
const IT = {
  ...
  priorityLow: "Bassa",
  priorityHigh: "Alta",
  hintHigh: "Priorità alta",
  hintBlocked: "Bloccata: aspetta che un'altra attività sia fatta",
  hintDecide: "Decisione da prendere: nelle note c'è la domanda",
  hintNotes: "Incontro già avvenuto, senza note",
  hintWaiting: "Ferma un'altra attività finché non è fatta",
  hintMeeting: "Appuntamento",
  hintLate: "In ritardo: la scadenza è passata",
  hintMilestone: "Traguardo: una data che conta",
...
const EN = {
  ...
  priorityLow: "Low",
  priorityHigh: "High",
  hintHigh: "High priority",
  hintBlocked: "Blocked: waiting for another task to be done",
  hintDecide: "A decision to make: the question is in the notes",
  hintNotes: "A meeting already held, without notes",
  hintWaiting: "Holds up another task until it is done",
  hintMeeting: "Appointment",
  hintLate: "Late: the deadline has passed",
  hintMilestone: "Milestone: a date that matters",
