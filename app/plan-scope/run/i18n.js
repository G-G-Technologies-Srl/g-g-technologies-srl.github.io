...
const IT = {
  ...
  meetingHint: "Scrivi cosa vi siete detti. Le righe che cominciano con «- [ ]» diventano attività "
    + "del progetto, quando lo chiedi dal menu.",
  ...
  contactsVcf: "vCard",
  rubricaHint: "Le persone con cui lavori, una volta sola per tutti i progetti. Una scheda si può "
    + "aggiungere qui, o nasce da sé la prima volta che scrivi un nome su un'attività.",
  rubricaSearch: "Cerca una persona",
  rubricaEmpty: "Ancora nessuno. La prima persona nasce da qui, o dal nome che scrivi su un'attività.",
...
const EN = {
  ...
  meetingHint: "Write down what you said to each other. Lines starting with “- [ ]” become tasks "
    + "of the project, when you ask for it from the menu.",
