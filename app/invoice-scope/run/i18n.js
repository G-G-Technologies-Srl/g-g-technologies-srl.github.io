...
const IT = {
  ...
  homeForecast: "Costi a fine anno",
  homeForecastSub: "quelli di oggi più {attesi} attesi in {quanti} scadenze",
  homeForecastChart: "Ricavi, costi e attesi nell'anno",
  homeExpectedShort: "attesi",
  ...
  solleciteCopyManual: "Il browser non consente la copia automatica: il testo è selezionato, premi Ctrl+C.",
  solleciteSubjectLabel: "Oggetto",
  solleciteTo: "A",
  solleciteMail: "Apri nella posta",
  solleciteNoAddress: "nessun indirizzo in anagrafica",
  ...
  solleciteTotal: "Totale dovuto: {totale}",
  ...
  homeMixNone: "Senza categoria",
  homeMixShare: "{quota}% del fatturato dell'anno · {quante} documenti",
  catTitle: "Le categorie dei documenti",
  catNote: "Scrivi la categoria, spunta i documenti a cui assegnarla e conferma. La categoria è "
    + "un'etichetta interna: non entra nel file elettronico e non compare sulla stampa.",
  catNone: "senza categoria",
  catPickAll: "Spunta tutti",
  catPickNone: "Togli la spunta",
  catOne: "Un documento scelto",
  catCount: "{quanti} documenti scelti",
  catApply: "Assegna",
  homeAging_corrente: "Non ancora scaduto",
  homeAging_g30: "Scaduto da 1–30 giorni",
  homeAging_g60: "Scaduto da 31–60 giorni",
  homeAging_g90: "Scaduto da 61–90 giorni",
  homeAging_oltre: "Scaduto da oltre 90 giorni",
  homeAgingOne: "Una rata",
  homeAgingMany: "{quante} rate",
  homeCash: "Fatturato e incassato per mese",
  homeCashInvoiced: "fatturato",
  homeCashCollected: "incassato",
  homeCashTip: "{mese} {anno}: fatturato {fatturato}, incassato {incassato}",
  homeCashImported: "Gli incassi importati da un registro portano la data di scadenza: il registro "
    + "non indica il giorno in cui il denaro è arrivato.",
  homePayers: "Come pagano i clienti",
  homePayersNote: "Media dei giorni fra la scadenza e il saldo, sulle fatture chiuse. Il segno meno "
    + "indica un pagamento in anticipo.",
  homePayersDays: "{giorni} gg",
  homePayersOnTime: "in giornata",
  homePayersCount: "{quante} fatture",
  ...
  expectedConfirm: "Conferma",
  expectedLate: "in ritardo",
  recurringTitle: "Costi ricorrenti",
  recurringNote: "Il canone, l'affitto, l'assicurazione: quello che torna ogni mese o ogni anno. Scritto una volta, fa il previsionale da solo.",
  recurringEmpty: "Nessuna ricorrenza. Aggiungine una e la Situazione mostra i costi previsti fino a fine anno.",
  recurringNew: "Nuova ricorrenza",
  recurringEdit: "Modifica la ricorrenza",
  recurringDeleteAsk: "Togliere questa ricorrenza? Gli acquisti già confermati restano.",
  recurringEvery: "{cadenza}, il {giorno}",
  recurringHint: "Il giorno è quello in cui di solito arriva la fattura; se il mese è più corto vale l'ultimo. «Fino al mese» vuoto: finché non la togli.",
  recNeedsDescription: "Manca la descrizione.",
  colDescription: "Descrizione",
  f_giorniScadenza: "giorni per il pagamento",
  ...
  plansTitleNew: "Nuova fattura ricorrente",
  plansTitleEdit: "Fattura ricorrente",
  plansDeleteAsk: "Elimino questa ricorrenza? Le fatture già create restano come sono.",
  planNeedsParty: "Manca il cliente.",
  colFrequency: "Cadenza",
  colNet: "Imponibile",
  f_cadenza: "cadenza",
  f_giorno: "giorno del mese",
  f_da: "dal mese",
  f_a: "fino al mese",
  cadMensile: "mensile",
  cadTrimestrale: "trimestrale",
  cadAnnuale: "annuale",
  ...
  archiveDocs: "documenti",
  archiveParties: "anagrafiche",
  archivePayments: "incassi",
  archiveCosts: "acquisti",
  archiveOutlays: "pagamenti in uscita",
  archiveItems: "voci di listino",
  archiveProjects: "progetti",
  archivePages: "pagine di progetto",
  archiveTasks: "attività",
  archiveActivities: "voci di diario",
  ...
  tc7: "Veicoli per competizioni sportive",
  tc8: "Noleggio veicoli SM",
  tc9: "Veicoli disabili SM",
  tc10: "B.S. 1% — direttamente strumentale",
  tc11: "B.S. 1% — attività immobiliari",
  tc12: "B.S. settore agricolo 1%",
  tc13: "B.S. settore agricolo — cooperative 50%",
  tc14: "B.S. 1% — associazioni benefiche",
  tc15: "B.S. 6% — costruzioni, ristrutturazioni e impianti su immobili",
  tc16: "Vendite a Stato o Federazioni C.O.N.S.",
  tc19: "Incentivo auto elettriche, plug-in o a idrogeno",
  tc21: "B.S. 5% — associazioni iscritte alla Consulta",
  tc22: "B.S. 2% — imposta agevolata",
  tc23: "Ricambi con o senza manutenzione veicoli B.S. SM 1%",
  tc24: "Ricambi con o senza manutenzione veicoli per competizioni sportive 3%",
  ...
  vVariazioniSoloNote: "la variazione contrattuale riguarda le note di credito e di debito",
  vVariazioniSoloNoteFix: "Su una fattura la spunta non ha significato: toglila.",
  vNonRimbFuoriLuogo: "«non rimborsabile» vale solo dove esiste il rimborso monofase",
  vNonRimbFuoriLuogoFix: "Su questa direzione il marcatore non viene letto da nessuno: toglilo.",
  vCessioneFuoriLuogo: "il tipo cessione vale solo dove c'è un rimborso monofase",
  vCessioneFuoriLuogoFix: "Il rimborso esiste per i tipi merce 1 e 2. Su questo documento il codice "
    + "non produce niente: toglilo.",
  vCessioneFix: "L'Ufficio Tributario ammette {elenco}. Qui c'è {valore}.",
  ...
  demoPlanAssistenza: "Assistenza mensile su impianto",
  ...
  settleDone: "saldata",
  settleLeft: "resta {importo}",
  settleOverdue: "in ritardo · resta {importo}",
  docsMoney: "incasso",
  docsMoneyAll: "Tutte",
  docsMoneyOpen: "Da incassare",
...
const EN = {
  ...
  homeForecast: "Costs to year end",
  homeForecastSub: "today's plus {attesi} expected over {quanti} due dates",
  homeForecastChart: "Revenue, costs and expected over the year",
  homeExpectedShort: "expected",
  ...
  solleciteCopyManual: "The browser does not allow copying automatically: the text is selected, press Ctrl+C.",
  solleciteSubjectLabel: "Subject",
  solleciteTo: "To",
  solleciteMail: "Open in mail",
  solleciteNoAddress: "no address on file",
  ...
  homeMixEmpty: "No document carries a category yet. Assign them to see how the year's revenue "
    + "divides up.",
  homeMixNone: "No category",
  homeMixShare: "{quota}% of the year's revenue · {quante} documents",
  catTitle: "Document categories",
  catNote: "Write the category, tick the documents to assign it to, and confirm. The category is "
    + "an internal label: it does not enter the electronic file and does not appear in print.",
  catNone: "no category",
  catPickAll: "Tick all",
  catPickNone: "Untick all",
  catOne: "One document selected",
  catCount: "{quanti} documents selected",
  catApply: "Assign",
  homeAging_corrente: "Not yet due",
  homeAging_g30: "Overdue 1–30 days",
  homeAging_g60: "Overdue 31–60 days",
  homeAging_g90: "Overdue 61–90 days",
  homeAging_oltre: "Overdue 90+ days",
  homeAgingOne: "One instalment",
  homeAgingMany: "{quante} instalments",
  homeCash: "Invoiced and collected by month",
  homeCashInvoiced: "invoiced",
  homeCashCollected: "collected",
  homeCashTip: "{mese} {anno}: invoiced {fatturato}, collected {incassato}",
  homeCashImported: "Payments imported from a register carry the due date: the register does not "
    + "state the day the money arrived.",
  homePayers: "How customers pay",
  homePayersNote: "Average days between the due date and settlement, on closed invoices. A minus "
    + "sign means payment ahead of time.",
  homePayersDays: "{giorni} d",
  homePayersOnTime: "same day",
  homePayersCount: "{quante} invoices",
  ...
  expectedLate: "late",
  recurringTitle: "Recurring costs",
  recurringNote: "The hosting fee, the rent, the insurance: what comes back every month or every year. Written once, it makes the forecast by itself.",
  recurringEmpty: "No recurring cost yet. Add one and the overview shows the costs expected to the end of the year.",
  recurringNew: "New recurring cost",
  recurringEdit: "Edit the recurring cost",
  recurringDeleteAsk: "Remove this recurring cost? The purchases already confirmed stay.",
  recurringEvery: "{cadenza}, on the {giorno}",
  recurringHint: "The day is when the invoice usually arrives; in a shorter month the last day counts. «Until» empty: until you remove it.",
  recNeedsDescription: "The description is missing.",
  colDescription: "Description",
  f_giorniScadenza: "days to pay",
  toIssueTitle: "Invoices to issue",
  toIssueNote: "The occurrences of recurring invoices that have no document yet. “Create the "
    + "draft” prepares the invoice with the customer, the line and the due date already on "
    + "it: the number is assigned when you issue it.",
  toIssueTotal: "{totale} in total",
  toIssueMake: "Create the draft",
  toIssueLate: "to do",
  plansTitle: "Recurring invoices",
  plansNew: "New recurring invoice",
  plansNote: "The retainer, the fixed hours, the subscription: what you invoice to the same "
    + "customer at regular intervals. Written once.",
  plansEmpty: "Invoices that repeat show up here.",
  plansHint: "The draft is created with the occurrence's date and the due date worked out from the "
    + "days given. Nature and goods type are decided by the customer's channel when it is created.",
  plansTitleNew: "New recurring invoice",
  plansTitleEdit: "Recurring invoice",
  plansDeleteAsk: "Delete this recurring invoice? Invoices already created stay as they are.",
  planNeedsParty: "The customer is missing.",
  colFrequency: "Frequency",
  colNet: "Net amount",
  f_cadenza: "frequency",
  f_giorno: "day of the month",
  f_da: "from month",
  f_a: "until month",
  cadMensile: "monthly",
  cadTrimestrale: "quarterly",
  cadAnnuale: "yearly",
  ...
  archiveLook: "What is in it",
  archiveReading: "Looking inside…",
  archiveSame: "in line with what you have now",
  archiveDiff: "different from what you have now",
  archiveNow: "now",
  archiveWritten: "written on {when}",
  archiveUnreadable: "This copy cannot be read.",
  archiveDocs: "documents",
  archiveParties: "contacts",
  archivePayments: "payments in",
  archiveCosts: "purchases",
  archiveOutlays: "payments out",
  archiveItems: "price list entries",
  archiveProjects: "projects",
  archivePages: "project pages",
  archiveTasks: "tasks",
  archiveActivities: "diary entries",
  ...
  tm4: "Consumer goods",
  tm7: "Capital goods",
  docTipoCessione: "Cession type",
  tcNessuno: "— none",
  tcNota: "Only needed when claiming the single-stage refund. The refund itself is created by the "
    + "tax office, grouping the invoices that carry the same code.",
  tc1: "Capital goods — vehicles",
  tc2: "Capital goods — used vehicle 8.5%",
  tc5: "Spare parts, with or without servicing, to the State",
  tc7: "Vehicles for sporting competitions",
  tc8: "Vehicle rental SM",
  tc9: "Vehicles for disabled people SM",
  tc10: "Capital goods 1% — directly instrumental",
  tc11: "Capital goods 1% — property business",
  tc12: "Capital goods, farming 1%",
  tc13: "Capital goods, farming — cooperatives 50%",
  tc14: "Capital goods 1% — charities",
  tc15: "Capital goods 6% — building work and installations",
  tc16: "Sales to the State or C.O.N.S. federations",
  tc19: "Incentive for electric, plug-in or hydrogen cars",
  tc21: "Capital goods 5% — associations on the Consulta register",
  tc22: "Capital goods 2% — reduced tax",
  tc23: "Spare parts for capital-goods vehicles SM 1%",
  tc24: "Spare parts for competition vehicles 3%",
  ...
  vVariazioniSoloNote: "a contractual variation applies to credit and debit notes",
  vVariazioniSoloNoteFix: "On an invoice the tick means nothing: clear it.",
  vNonRimbFuoriLuogo: "\u201Cnot refundable\u201D only applies where the single-stage refund exists",
  vNonRimbFuoriLuogoFix: "On this direction nobody reads the marker: clear it.",
  vCessioneFuoriLuogo: "the cession type only applies where a single-stage refund exists",
  vCessioneFuoriLuogoFix: "The refund exists for goods types 1 and 2. On this document the code "
    + "produces nothing: remove it.",
  vCessioneFix: "The tax office admits {elenco}. This says {valore}.",
  ...
  demoPlanAssistenza: "Monthly plant support",
